...
import { useArchivalDerived } from './hooks/useArchivalDerived';
...
import { formatShortModelName } from './utils/formatModelName';
...
export const App: React.FC = () => {
  ...
  const { archivalDocuments, archivalChunks, selectedDocAuthors } = useArchivalDerived(sources, selectedDoc);
