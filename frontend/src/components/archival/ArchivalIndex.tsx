        ...
        <table className="w-full text-left border-collapse font-sans text-xs" role="table">
          <thead>
            <tr className="border-b border-[#E0E0DC] dark:border-[#2A2A2E] font-mono text-[11px] text-[#666666] dark:text-[#888888] uppercase bg-[#F2F2F0] dark:bg-[#19191C]">
              <th scope="col" className="p-3 font-medium border-r border-[#E0E0DC] dark:border-[#2A2A2E] w-12 text-center">N°</th>
              <th scope="col" className="p-3 font-medium border-r border-[#E0E0DC] dark:border-[#2A2A2E]">Título y Autoría</th>
              <th scope="col" className="p-3 font-medium border-r border-[#E0E0DC] dark:border-[#2A2A2E] w-24">Año</th>
              <th scope="col" className="p-3 font-medium border-r border-[#E0E0DC] dark:border-[#2A2A2E] w-56">DOI / Acceso</th>
              <th scope="col" className="p-3 font-medium border-r border-[#E0E0DC] dark:border-[#2A2A2E] w-28 text-right">Fragmentos</th>
              <th scope="col" className="p-3 font-medium w-28 text-center">Estado</th>
            </tr>
          </thead>
